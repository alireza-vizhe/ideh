...
const Nomone = () => {
  ...
  useEffect(() => {
    ...
    return(
      ...
      <Navbar />
      <Helmet>
          <title> نمونه کار | ایده نگار</title>
        </Helmet>
      <section className="mt-5 sec-website-p">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6">
              <h1>تمامی نمونه کار های ایده نگار</h1>
              ...
              <p>
                ...
                رایگان برای وب سایت شما, تحویل برنامه pwa هنکام تحویل وب سایت, Seo و دیجیتال مارکتینگ
              </p>
            ...
            if(item.singleShow === 'true' && item.category === "اختصاصی" && item.status === "public"){
              return (
                <>
