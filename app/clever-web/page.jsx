...
const Website = () => {
  ...
  return (
    <>
      <Navbar />
      <Helmet>
          <title>سایت شرکتی خدماتی | ایده نگار</title>
        </Helmet>
      <section className="mt-5 sec-website-p">
        <div className="container">
          <div className="row">
            ...
            <div className="col-md-6">
              <h1>طراحی وب سایت شرکتی خدماتی</h1>
           ...
           {posts.map((item, index) => {
            ...
            if(item.singleShow === "true" && item.category === "شرکتی و خدماتی" && item.status === "public"){
              return (
                <>
            ...
            <div className="col-md-6 img-p-sec-web p-4 my-4">
              <h6 className="text-center my-3 nomone-web-sec-title">
                مشاهده آخرین نمونه کار طراحی سایت شرکتی و خدماتی
              </h6>
              <img
            ...
            <div className="col-md-12">
              <h4 className="title-sec-clever">
                نمونه کار طراحی وب سایت های شرکتی و خدماتی
              </h4>
            </div>
           ...
           {posts.map(item => {
            ...
            <div className="text-center">
              ...
              <h2 className="titile-sub-clever">هزینه طراحی سایت شرکتی و خدماتی</h2>
            ...
            <div className="col-md-3 my-3">
              <div className="card prices-box important-p">
