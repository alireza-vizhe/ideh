...
import appImg from "../public/img/appImg.png"
...
const MobileApp = () => {
  ...
  useEffect(() => {
    ...
    return(
      ...
      <Navbar />
      <Helmet>
          <title> اپلیکیشن موبایل | ایده نگار</title>
        </Helmet>
      <section className="mt-5 sec-website-p">
        <div className="container">
          <div className="row">
            ...
            if(item.singleShow === 'true' && item.category === "موبایل" && item.status === "public"){
              return (
                <>
              ...
              <div className="card details-nomone-sec-web">
                <div className="card-body">
                  ...
                  <ul className="sec-web-nomone-ul my-3">
                    <h6>ویژگی های ظاهری اپلیکیشن</h6>
                  ...
                  <ul className="sec-web-nomone-ul my-3">
                    <h6>ویژگی های عملکرد اپلیکیشن</h6>
            ...
            <div className="col-md-6 img-p-sec-web p-4 my-4">
              <h6 className="text-center my-3 nomone-web-sec-title">
                مشاهده آخرین نمونه کار طراحی اپلیکیشن اختصاصی
              </h6>
              <img
           ...
           {posts.map(item => {
            ...
            if(item.category === "موبایل" && item.status === "public"){
              return (
